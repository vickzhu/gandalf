...
import static com.gandalf.framework.util.Assert.ExceptionType.ILLEGAL_ARGUMENT;
import static com.gandalf.framework.util.Assert.ExceptionType.UNEXPECTED_FAILURE;
import static com.gandalf.framework.util.Assert.ExceptionType.UNREACHABLE_CODE;
import static com.gandalf.framework.util.Assert.ExceptionType.UNSUPPORTED_OPERATION;

import com.gandalf.framework.exception.UnexpectedFailureException;
import com.gandalf.framework.exception.UnreachableCodeException;
