...
public class HttpTool {
	...
	private static final Charset DEFAULT_CHARSET = Charset.forName(CharsetConstant.UTF_8);
	 ...
	 * @return
	 */
	public static String getWithProxy(String url, Map<String, String> headerMap, Map<String, String> cookieMap,
			HttpHost proxy) {

		RequestConfig requestConfig = RequestConfig.custom().setProxy(proxy).setConnectTimeout(5000)
				.setSocketTimeout(5000).setConnectionRequestTimeout(3000).build();
	 ...
	 */
	public static String post(String url, Map<String, String> headerMap, Map<String, String> paramMap,
			Map<String, String> cookieMap, Charset charset) {
	 ...
	 * @return
	 */
	public static String postWithProxy(String url, Map<String, String> headerMap, Map<String, String> paramMap,
			Map<String, String> cookieMap, HttpHost proxy) {
	 ...
	 */
	public static String postWithProxy(String url, Map<String, String> headerMap, Map<String, String> paramMap,
			Map<String, String> cookieMap, InetSocketAddress proxy) {
		HttpClientContext context = null;
		if (proxy != null) {
			context = HttpClientContext.create();
			context.setAttribute("socks.address", proxy);
	...
	private static String post(String url, Map<String, String> headerMap, Map<String, String> paramMap,
			Map<String, String> cookieMap, RequestConfig requestConfig, HttpClientContext context) {
		HttpClient httpClient = HttpClientFactory.getDefaultHttpClient();
	 ...
	 * @return
	 */
	public static String postJsonWithProxy(String url, Map<String, String> headerMap, String bodyJson,
			Map<String, String> cookieMap, HttpHost proxy) {
	...
	private static String postJson(String url, Map<String, String> headerMap, String bodyJson,
